...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_cat (
	 ...
	 image_type varchar(250) DEFAULT '',
	 ...
	 authors text,
	 translators text,
	 bid varchar(250) NOT NULL default '',
	 admins text,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_get_chap (
	 ...
	 url_html_pattern varchar(250) DEFAULT '', 
	 url_pattern varchar(250) DEFAULT '',
	 img_structure varchar(250) DEFAULT '',
	 chapno_structure varchar(250) DEFAULT '',
	 preg_img_structure varchar(250) DEFAULT '',
	 replace_1 varchar(250) DEFAULT '',
	 replace_2 varchar(250) DEFAULT '',
	 replace_3 varchar(250) DEFAULT '',
	 numget_img varchar(250) DEFAULT '',
	 preg_chapno_structure varchar(250) DEFAULT '',
	 numget_chap varchar(250) DEFAULT '',
	 add_time int(11) unsigned NOT NULL DEFAULT '0',
	 edit_time int(11) unsigned NOT NULL DEFAULT '0',
	 PRIMARY KEY (id)
	) ENGINE=MyISAM";
