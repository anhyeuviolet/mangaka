...
$lang_module['categories'] = 'Quản lý Manga';
$lang_module['categories_list'] = 'Danh sách Manga';
...
$lang_module['error_save_permission'] = 'Lỗi: Bạn không có đủ quyền để thực hiện lưu dữ liệu';
...
$lang_module['description_html'] = 'Miêu tả chi tiết';
...
$lang_module['progress'] = 'Tiến độ';
$lang_module['progressview'] = 'Tiến độ cập nhật';
$lang_module['progress_1'] = 'Đang tiến hành ';
$lang_module['progress_2'] = 'Đã hoàn thành ';
$lang_module['progress_3'] = 'Drop ( ngừng )';
...
$lang_module['delcat_msg_cat'] = 'Manga này có %s Manga thành phần, bạn cần xóa hoặc di chuyển các Manga thành phần trước';
$lang_module['delcat_msg_rows'] = 'Manga có %s bài viết, bạn có chắc chắn xóa hoặc di chuyển sang Manga khác';
$lang_module['delcat_msg_rows_select'] = 'Chú ý: Manga %s có %s bài viết. <br />Bạn xóa Manga này tức là xóa tất cả bài viết bên trong nó.';
$lang_module['delcat_msg_rows_move'] = 'Hoặc chọn Manga để di chuyển bài viết tới';
$lang_module['delcat_msg_cat_permissions'] = 'Bạn không có quyền thực hiện thao tác này';
$lang_module['delcatandrows'] = 'Xóa Manga và các bài viết';
$lang_module['delcat_msg_rows_noselect'] = 'Bạn cần chọn Manga để di chuyển bài viết tới';
...
$lang_module['viewcat_page'] = 'Cách thể hiện Manga';
$lang_module['viewcat_page_new'] = 'danh sách, mới lên trên';
$lang_module['viewcat_page_old'] = 'danh sách, cũ lên trên';
$lang_module['viewcat_main_left'] = 'Manga, tin khác nằm bên trái';
$lang_module['viewcat_main_right'] = 'Manga,tin khác nằm bên phải';
$lang_module['viewcat_main_bottom'] = 'Manga,tin khác nằm bên dưới';
...
$lang_module['viewcat_home'] = 'Trang chủ dạng List Manga';
...
$lang_module['search_cat'] = 'Manga bài viết';
$lang_module['search_cat_all'] = 'Tất cả các Manga';
...
$lang_module['chapter_no'] = 'Chương số';
$lang_module['chapter_sort'] = 'Thứ tự';
...
$lang_module['facebookAdminID'] = 'Facebook Admin ID';
$lang_module['facebookcomment'] = 'Sử dụng Facebook Comment';
...
$lang_module['admin_cat'] = 'Quản lý Manga';
$lang_module['admin_cat_for_user'] = 'Quyền hạn của bạn tại các Manga';
...
$lang_module['permissions_pub_error'] = 'Lỗi: Bạn không được đăng bài viết tại Manga: %1$s';
$lang_module['permissions_sendspadmin_error'] = 'Lỗi: Bạn không được phép chuyển bài viết cho tổng biên tập tại Manga: %1$s';
$lang_module['permissions_pub_show_error'] = 'Lỗi: Bạn không được cho hiển thị bài viết tại Manga: %1$s';
...
$lang_module['genre'] = 'Thể loại';
$lang_module['add_genre'] = 'Thêm Thể loại';
$lang_module['edit_genre'] = 'Sửa Thể loại';
$lang_module['genre_alias'] = 'Lọc bỏ dấu tiếng việt, các ký tự khác a-z, 0-9, - trong Liên kết tĩnh của Thể loại';
$lang_module['alias_search'] = 'Để hiển thị các Thể loại khác, bạn dùng chức năng tìm kiếm để hiển thị nhiều kết quả hơn';
$lang_module['genre_all_link'] = 'Chế độ xem các Thể loại chưa có mô tả đang được kích hoạt, nhấp vào đây để xem tất cả các Thể loại';
...
$lang_module['manga'] = 'Manga';
$lang_module['total_chapter'] = 'Tổng số Chương';
$lang_module['total_view'] = 'Tổng lượt xem';
$lang_module['total_manga'] = 'Tổng số Manga';

$lang_module['manga_statistic'] = 'Thống kê modules Manga';
$lang_module['choose_admin_act'] = 'Chọn chức năng quản lý';
$lang_module['manga_manage'] = ' Quản lý Manga';
$lang_module['genre_manage'] = ' Quản lý Thể loại';

$lang_module['tool_upload'] = ' Công cụ Upload';
$lang_module['tool_leech'] = ' Công cụ Leech';

$lang_module['author'] = 'Tác giả';
$lang_module['translator'] = 'Nhóm dịch';
$lang_module['updating'] = 'Đang cập nhật';
$lang_module['inhome_1'] = 'Có ';
$lang_module['inhome_0'] = 'Không ';
$lang_module['link_per_page'] = 'Số liên kết mỗi trang';

$lang_module['getchap'] = 'Leech Chapter';
$lang_module['getmanga_conf'] = 'Cấu hình Leech Manga';
$lang_module['getmanga'] = ' Leech Manga';

//Lang for function getchap_conf
$lang_module['getchap_conf'] = 'Cấu hình Leech Chapter';
...
$lang_module['img_structure'] = 'Mảng chứa hình ảnh';
$lang_module['chapno_structure'] = 'Cấu trúc phần tử chứa Tiêu đề/Chapter';
$lang_module['error_required_url_html_pattern'] = 'Lỗi: bạn cần nhập dữ liệu cho Mảng chứa danh sách link chap';
$lang_module['error_required_url_pattern'] = 'Lỗi: bạn cần nhập dữ liệu cho Phần tử chứa link';
